...
1. raised issue and recommendations in 
	1. Corporate social resoponsibility - 
		1. gaps in implementation, unspend CSR mech. not transparent, 
		2. recs - introduce penalties for non-compliance,
	2. insolvency and backruptcy code - 
		1. non-consistent interpretation of laws, non-clear mech for complains against Resolution Professionals, conflicts of interest
		2. recs - rigorous induction process, and independent audit of RPs, ensure adequate representation of stakeholders in committee of creditors
	3. Envt, social and governance (ESG) - 
		1. greenwashing, small enterprizes facing difficulty
		2. recs - dedicate body for enforcement and monitoring, amend companies act 