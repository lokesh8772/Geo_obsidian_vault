...
1. RS resolution - 
	1. when RS passes a resolution with 2/3rd majority of present and voting for this. 
...
4. governor may be required to get prior instructions from the POI in some special cases of issuing ordinances.(213)
	1. if the same law, when introduced by the state legislature would have required POI's instruc